...
if cantidad_yellow > 1:
    ...
    resultado['yellow'] = '%s,%s,%s,%s' % (precio_max_yellow, precio_min_yellow, precio_prom_yellow, cantidad_yellow)

if cantidad_green > 1:
    precio_prom_green = precio_acum_green / float(cantidad_green)
    resultado['green'] = '%s,%s,%s,%s' % (precio_max_green, precio_min_green, precio_prom_green, cantidad_green)
