...
def load_model(pais):
    ...
    if pais == 'ARG':
        ...
        clf = load(cwd + '/assets/pys/modelo_tendencia_mix.joblib')    
        loaded_vec = CountVectorizer(decode_error="replace",vocabulary=pickle.load(open(cwd + "/assets/pys/vocabulario_tendencia_mix.pkl", "rb")))
